        ...
        <div className="grid md:grid-cols-[200px_1fr] lg:grid-cols-[250px_1fr] gap-8 md:gap-12">
          ...
          >
            <h2 className="text-[32px] text-gray-700 leading-[1.45] font-medium mb-12 max-w-[1000px] tracking-tight">
              <span className="font-bold text-gray-900">Al Bastaki</span> was founded in 2000 with a simple mission: to empower businesses with financial clarity and strategic direction. What began as a local PRO firm has evolved into a full-service consultancy serving 2,250+ clients across the UAE. In 2022, our services expanded across the GCC, including Oman, to support regional clients with the same dependable execution.
            </h2>
