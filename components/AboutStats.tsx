    ...
    <section className="bg-[#F9FAFB] py-24 md:py-32 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 xl:px-8">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          {/* Left Side (Image & Floating Details) */}
          <div className="relative isolate z-10 w-full lg:w-[90%] pt-8">
            ...
            {/* Floating Details Box (About variant: no achievements) */}
            <motion.div
            ...
            >
              ...
              <div className="text-[11px] font-bold text-gray-800 uppercase tracking-widest mb-8">
                Service Snapshot
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-start gap-6">
                  ...
                  <span className="font-bold text-[#1A1E23] text-[14.5px] text-right">Accuracy</span>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col relative z-20 lg:pl-8 xl:pl-4 mt-20 lg:mt-0">
            ...
            {/* Quote card (same styling as homepage) */}
            <motion.div
