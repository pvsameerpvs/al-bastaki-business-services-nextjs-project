        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          <div className="relative isolate z-10 w-full lg:w-[90%] pt-8">
            ...
            >
              ...
              <div className="text-[11px] font-bold text-gray-800 uppercase tracking-widest mb-8">Service Snapshot</div>
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                   ...
                   <span className="font-bold text-[#1A1E23] text-[14.5px]">Right route</span>
                </div>
                <div className="flex justify-between items-center">
                   <span className="font-bold text-[#1A1E23] text-[14.5px]">PRO &amp; Registration</span>
                   <span className="font-bold text-[#1A1E23] text-[14.5px]">Tracked follow-ups</span>
                </div>
                <div className="flex justify-between items-center">
                   <span className="font-bold text-[#1A1E23] text-[14.5px]">Accounting Support</span>
                   <span className="font-bold text-[#1A1E23] text-[14.5px]">Accuracy</span>
                </div>
              </div>
            </motion.div>
          </div>
