    ...
    <section className="py-20 md:py-28 bg-[#F9FAFB]">
      <div className="max-w-[1400px] mx-auto px-6 xl:px-8">
        ...
        <div className="flex flex-wrap gap-2.5 justify-center md:justify-end mb-8">
          ...
          <Link
            href="/case-studies/business-setup"
            className="rounded-full px-4 py-2 text-[13px] font-semibold border border-gray-200 bg-white text-gray-700 hover:border-primary/40 hover:text-primary transition-colors"
          >
            Business Setup
          </Link>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {items.map((item, idx) => (
            <FadeIn key={item.id} delay={Math.min(idx, 5) * 0.06}>
              <div className="bg-white rounded-[1.75rem] overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.03)] border border-gray-100 group hover:shadow-[0_15px_50px_rgba(0,0,0,0.06)] hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="p-7 md:p-8">
                  ...
                  <h3 className="text-[20px] md:text-[22px] font-bold text-[#2d3748] leading-[1.25] tracking-tight group-hover:text-primary transition-colors duration-300">
                    {item.title}
                  </h3>
